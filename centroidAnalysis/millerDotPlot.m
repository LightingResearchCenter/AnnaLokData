function hpol = millerDotPlot(varargin)
...
%         end
        ...
        for i = 1 : length(th)
            ...
            text(-rt * cst(i), -rt * snt(i), [loc,':00'], 'HorizontalAlignment', 'center', ...
                'HandleVisibility', 'off', 'Parent', cax);
        end
    ...
    if strcmp(line_style, 'auto')
        q = plot(xx, yy, 'LineWidth',1.5, 'Parent', cax);
    else
        q = plot(xx, yy, line_style, 'LineWidth',1.5, 'Parent', cax);
    end
